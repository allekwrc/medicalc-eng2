...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 style = "text-align:center" class="page-header">Resultado do Cálculo de Correção de Albumina</h1>
                </div>
            </div>
          ...
          <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item" style="text-align: center;">
                  <center><table class="tg" style="text-align: center;">
                    <tr>
                        <th class="tg-v0hj" colspan="10">Parâmetros para Equação - Correção de Albumina</th>
                    </tr>
                    <tr>
                   ...
                   <tr>
                      <td class="tg-us36"><span style="font-weight:bold">Correção do Albumina</span></td>
                      <td class="tg-ey81">CaALb_c<br></td>
                      <td class="tg-us36">S</td>
                      <td class="tg-ey81">8.5</td>
                      <td class="tg-us36">10.5</td>
                      <td class="tg-ey81">0</td>
